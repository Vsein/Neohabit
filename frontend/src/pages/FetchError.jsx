    ...
    <div className="contentlist centering">
      ...
      {process.env.REACT_APP_STAGE === 'public-prod' ? (
        <>
          ...
          <p className="back-ref" style={{ width: 'min(100%, 800px)' }}>
            Otherwise, you might have exceeded the allowed limit of requests, try again in a
            minute...
          </p>
        </>
      ) : (
        <>
          <p className="back-ref" style={{ width: 'min(100%, 800px)' }}>
            If you stumbled here, try refreshing the page. If it doesn&apos;t help, and you&apos;re
            hosting Neohabit yourself, check your internet connection/server availability.
          </p>
          <p className="back-ref" style={{ width: 'min(100%, 800px)' }}>
            Otherwise, you can try to login in a new private window and test things there, or{' '}
            <a className="inline" onClick={logout} style={{ cursor: 'pointer' }}>
              log out{' '}
            </a>
          ...
          <p className="back-ref" style={{ width: 'min(100%, 800px)' }}>
            ...
            and{' '}
            <Link className="inline" to="https://github.com/Vsein/Neohabit/issues">
              submit a bug report
            </Link>
            .
          </p>
