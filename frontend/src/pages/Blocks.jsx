  ...
  return (
    <div className="contentlist">
      ...
      <p className="back-ref" style={{ width: 'min(100%, 800px)' }}>
        My ultimate vision for Neohabit is to have a public, community-driven base of habits,
        which you would be able to explore and pick the ones you would like to build. I&apos;ll aim to
