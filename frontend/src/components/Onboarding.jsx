...
const Slides = [
  {
    content: <>
      ...
      <p>
        ...
        <br />
        <br />
        Also notice how {new Date().toLocaleDateString('en-US', { weekday: 'long' })} and {new Date().toLocaleDateString('en-US', { month: 'long' })} are highlighted.
      </p>
    </>,
    tag: 'date-indicators',
  },
  ...
  },
  {
    content: <>
      <h3>Good luck!</h3>
      <p>
        The last three buttons allow you to open the stopwatch, edit the habit, and delete
        it. For the sake of brevity, I won&apos;t force you to click on them :D
      </p>
    </>,
    tag: 'final',
  }
