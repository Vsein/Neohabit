...
<p float="left">
  ...
  &nbsp;
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="frontend/src/assets/heatmap-numeric-custom-violet-dark.png" />
    <img src="frontend/src/assets/heatmap-numeric-custom-violet-light.png" width="49%"/>
  </picture>
</p>
